...
- **(a)** *Definitions* For purposes of section:
  ...
  - **(4)** *Natural gas pipeline property* The term natural gas pipeline property means all property, real, personal, and intangible, used by a natural gas pipeline providing transportation or storage of natural gas, subject to the jurisdiction of the Federal Energy Regulatory Commission.
