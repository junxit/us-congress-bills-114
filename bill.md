...
- **(a)** *In general* Subtitle C of title IV of the Homeland Security Act of 2002 (6 U.S.C. 231 et seq.) is amended by adding at the end the following new section:
  ...
  > - **(d)** *Major acquisition program defined* In this section, the term “major acquisition program” means a Department acquisition program that is estimated by the Secretary to require an eventual total expenditure of at least $300,000,000 (based on fiscal year 2015 constant dollars) over its life cycle cost.
