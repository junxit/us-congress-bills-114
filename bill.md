...
- **(a)** *Meat and meat food products* Section 1(m) of the Federal Meat Inspection Act (21 U.S.C. 601(m)) is amended—
  ...
  - **(2)** in paragraph (2)—
    ...
    - **(B)** by inserting after subparagraph (A) the following new subparagraph:
      > - **(B)** if it bears or contains a strain of a microbial pathogen, such as Campylobacter or Salmonella, that is resistant to not fewer than two critically important antibiotics for human medicine (as specified in the World Health Organization’s list of Critically Important Antimicrobials);
