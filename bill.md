...
This Act may be cited as the “American Entrepreneurship and Investment Act of 2015”.
...
- **(a)** *Reforming the EB–5 immigrant investor program* Section 203(b)(5) of the Immigration and Nationality Act (8 U.S.C. 1153(b)(5)) is amended as follows:
  ...
  - **(3)** *Permanent authorization of regional center program* By adding after subparagraph (D) the following:
  ...
  - **(4)** *Preventing fraud in the regional center program* In subparagraph (E) (as added by paragraph (5)), by inserting after clause (iii) the following:
  ...
  - **(5)** *EB–5 petitions* By adding after subparagraph (E) (as amended by paragraph (6)) the following:
    > - **(F)** *EB–5 petitions*
...
## § 5. Applicability of Foreign Corrupt Practices Act
...
## § 7. Consultation with Secretary of Commerce
