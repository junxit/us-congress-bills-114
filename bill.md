...
- **(6)** in section 7—
  ...
  - **(B)** in paragraph (6), by redesignating subparagraphs (A) and (B) as clauses (i) and (ii), respectively, and indenting the clauses accordingly;
  - **(C)** by redesignating paragraphs (1) through (6) as subparagraphs (A) through (F), respectively, and indenting the subparagraphs accordingly;
