...
- **(1)** in subparagraph (F)—
  ...
  - **(C)** by adding at the end the following:
    > - **(iv)** of the crimes described in subclauses (I) through (IX) of clause (i), in which a firearm (as defined in section 921(a)(3) of title 18, United States Code) was present at the scene of the crime.
