...
- Whereas the NTIA has stated that there is no deadline for the transition, and that the transition proposal must have broad community support and must—(1)support and enhance the multistakeholder model;(2)maintain the security, stability, and resiliency of the Internet DNS;(3)meet the needs and expectations of the global customers and partners of the Internet Assigned Numbers Authority; and(4)maintain the openness of the Internet;
