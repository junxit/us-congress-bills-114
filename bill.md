...
- **(2)** by inserting after subsection (b) the following new subsection:
  ...
  >   - **(2)** *Means of disposal; prioritization* Beginning on the date the 6-year period described in paragraph (1) ends, contributions or donations that remain available to an individual described in such paragraph shall be disposed of, not later than 30 days after such date, as follows:
...
## § 3. One-year transition period for certain individuals
