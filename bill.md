...
> To require reductions in the direct cost of Federal regulation that are proportional to the amount of increases in the debt ceiling.

## § 1. Short title

This Act may be cited as the “Reducing Excessive Government Act of 2016” or the “REG Act”.
...
- **(a)** *Definitions* In this section—
  ...
  - **(6)** the term major rule means any rule that has or is likely to result in an annual effect on the economy of $100,000,000 or more.
...
- **(f)** *Effect of joint resolution*
  ...
  - **(2)** *Limitation on subsequent rulemaking* A rule that ceases to have force or effect under paragraph (1) may not be reissued in substantially the same form, and a new rule that is substantially the same as such a rule may not be issued, unless the reissued or new rule is specifically authorized by a law enacted after the date of the joint resolution repealing the original rule.
