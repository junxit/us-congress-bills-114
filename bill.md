...
- **(2)** by inserting after section 46 the following:
  ...
  >     - **(B)** includes—
  >       - **(i)** instruction on counseling small business concerns regarding adopting, making innovations in, and using broad­band and other emerging information technologies; and
  ...
  >     - **(C)** to the maximum extent practicable, uses the tools and training cataloged and identified under subsection (b)(2)(D).
  ...
  >     - **(A)** *In general* Subject to appropriations, the Chief Counsel for Advocacy shall conduct a study evaluating the impact of broad­band speed and price on small business concerns.
  ...
  >       - **(iii)** a survey of the type of broad­band technology used by small business concerns; and
