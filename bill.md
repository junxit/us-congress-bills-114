...
- **(b)** *Clarification of liability of Federal Government to third parties* Section 8162 of such title is amended by adding at the end the following new subsection:
  > - **(d)**
...
- **(d)** *Additional definitions* Section 8161 of such title is amended by adding at the end the following new paragraphs:
