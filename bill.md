...
- **(4)** If the NTIA uses its contract authority, the contractor, in the performance of its duties, must have or develop a close constructive working relationship with all interested and affected parties to ensure quality and satisfactory performance of the IANA functions. The interested and affected parties include—
  - **(A)** the multi-stakeholder, private sector led, bottom-up policy development model for the domain name system that the Internet Corporation for Assigned Names and Numbers represents;
