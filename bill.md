...
- **(a)** *In general* Not later than 90 days after the date of enactment of this Act, the Commissioner of Social Security, in consultation with the Secretary of Commerce, shall submit to Congress a plan, which shall include the elements described in subsection (b), to ensure the accuracy and completeness of the death data (including data regarding individuals who are not eligible for or receiving benefits under titles II or XVI of the Social Security Act) maintained and furnished by the Social Security Administration.
- **(b)** *Content of plan* The plan required under subsection (a) shall include the following elements:
  ...
  - **(3)** Improved policies and procedures to identify and correct errors in the records of the Numerical Identification System, and death data.
