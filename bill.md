...
This Act may be cited as the “Arrest Statistics Reporting Act of 2015”.
...
- **(3)** The offense for which the person was arrested, represented by the appropriate National Crime Information Center offense code.
...
- **(1)** a table containing the National Crime Information Center offense codes and the corresponding occurrences for each immigration status category; and
- **(2)** a table containing the National Crime Information Center offense codes and the corresponding occurrences for each nationality.
