...
- **(6)** by amending subclause (xi) to read as follows:
  ...
  >   - **(IV)** *Standard menu item* The term “standard menu item” means a food item of the type described in subclause (i) or (ii) of subparagraph (5)(A) with the same recipe prepared in substantially the same way with substantially the same food components that—
  ...
  >     - **(bb)** is not a food referenced in item (vii).
