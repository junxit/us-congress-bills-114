...
## § 4. Protection of information and security breach notification
...
- **(a)** *Security procedures required*
  ...
  - **(2)** *Objectives* The objectives of this subsection are to—
    - **(A)** ensure the security and confidentiality of sensitive financial account information and sensitive personal information;
  ...
  - **(4)** *Elements* In order to develop, implement, maintain, and enforce its information security program, a covered entity shall—
    ...
    - **(D)** oversee third-party service providers by—
      ...
      - **(iii)** reasonably oversee or obtain an assessment of the third-party service provider’s compliance with contractual obligations, where appropriate in light of the covered entity’s risk assessment; and
  ...
  - **(5)** *Security controls* Each covered entity shall—
    - **(A)** consider whether the following security measures are appropriate for the covered entity and, if so, adopt those measures that the covered entity concludes are appropriate—
      ...
      - **(ii)** access restrictions at physical locations containing sensitive financial account information or sensitive personal information, such as buildings, computer facilities, and records storage facilities, to permit access only to authorized individuals;
      ...
      - **(v)** dual control procedures, segregation of duties, and employee background checks for employees with responsibilities for, or access to, sensitive financial account information or sensitive personal information;
...
- **(c)** *Notice required*
  - **(1)** *In general* If a covered entity determines under subsection (b) that the unauthorized acquisition of sensitive financial account information or sensitive personal information involved in a breach of data security is reasonably likely to cause substantial harm to the consumers to whom the information relates, the covered entity, or a third party acting on behalf of the covered entity, shall—
    - **(A)** notify, without unreasonable delay—
      - **(i)** an appropriate Federal law enforcement agency;
      - **(ii)** the appropriate agency or authority identified in section 5;
...
## § 7. Delayed effective date for certain provisions
