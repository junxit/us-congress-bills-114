...
## § 1. Increase in child tax credit
...
- **(b)** *Increase in dollar threshold at which credit phase-Out begins*
  ...
  - **(2)** *Increase for additional qualifying children* Section 24(b) of such Code is amended by adding at the end the following new paragraph:
    > - **(3)** *Increase in threshold amount based on number of qualifying children* In the case of a taxpayer with 2 or more qualifying children, the threshold amount otherwise determined under paragraph (2) shall be increased by $15,000 for each qualifying child of the taxpayer in excess of the first such child.
