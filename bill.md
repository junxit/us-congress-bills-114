...
## § 3. Opioid use disorder treatment modernization
...
- **(a)** *In general* Section 303(g)(2) of the Controlled Substances Act (21 U.S.C. 823(g)(2)) is amended—
  ...
  - **(2)** in subparagraph (D)—
    ...
    - **(B)** in clause (ii), by striking “Upon receiving a notification under subparagraph (B)” and inserting “Upon receiving a determination from the Secretary under clause (iii) finding that a practitioner meets all requirements for a waiver under subparagraph (B)”; and
    - **(C)** in clause (iii)—
