...
- **(d)** *Terms and conditions*
  - **(1)** *Consideration*
    - **(A)** *In general* As consideration for the conveyance of the property under subsection (b), the City shall pay to the Archivist an amount not less than the fair market value of the conveyed property, to be determined as provided in subparagraph (B).
    - **(B)** *Appraisal* The fair market value of the property to be conveyed under subsection (b) shall be determined based on an appraisal that—
