...
## § 1. National Estuary Program reauthorization; competitive awards
...
- **(1)** in subsection (g), by adding at the end the following:
  ...
  >   - **(C)** *Selection of recipients* The Administrator shall select award recipients under this paragraph that, as determined by the Administrator, are best able to address urgent and challenging issues that threaten the ecological and economic well-being of coastal areas, including—
...
- **(2)** by striking subsection (i) and inserting the following:
  ...
  >   - **(2)** *Allocations*
  >     - **(A)** *Conservation and management plans* Not less than 80 percent of the amount made available under this subsection for a fiscal year shall be used by the Administrator for the development, implementation, and monitoring of each conservation and management plan eligible for grant assistance under subsection (g)(2).
  >     - **(B)** *Competitive awards* Not less than 15 percent of the amount made available under this subsection for a fiscal year shall be used by the Administrator for making competitive awards under subsection (g)(4).
