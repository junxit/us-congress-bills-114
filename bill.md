...
- **(a)** *Definitions*
  - **(1)** *In general* Subsection (a) of the second section 226 of the Homeland Security Act of 2002 (6 U.S.C. 148; relating to the National Cybersecurity and Communications Integration Center) is amended—
    ...
    - **(C)** by adding at the end the following new paragraphs:
      ...
      > - **(9)**
      >   - **(A)** the term “private entity” means a non-Federal entity that is an individual or private group, organization, proprietorship, partnership, trust, cooperative, corporation, or other commercial or non-profit entity, including an officer, employee, or agent thereof;
...
## § 3. Information sharing structure and processes
