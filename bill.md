...
>     - **(C)**
>       - **(i)** is intended for use solely in the transfer, aggregation, conversion (in accordance with a present specification), storage, management, retrieval, or transmission of data or information;
...
## § 3. Applicability and inapplicability of regulation
...
## § 4. Exclusion from definition of device
