...
This Act may be cited as the “Tobacco Tax Equity Act of 2015”.
...
- **(c)** *Tax parity for large cigars*
  ...
  - **(2)** *Guidance* The Secretary may issue guidance regarding the appropriate method for determining the weight of large cigars for purposes of calculating the applicable tax under section 5701(a)(2) of the Internal Revenue Code of 1986.
...
- **(g)** *Tax rates adjusted for inflation* Section 5701 of such Code is amended by adding at the end the following new subsection:
  > - **(i)** *Inflation adjustment*
  >   - **(1)** *In general* In the case of any calendar year beginning after 2015, the dollar amounts provided under this chapter shall each be increased by an amount equal to—
...
- **(h)** *Effective dates*
  ...
  - **(3)** *Large cigars* The amendments made by subsection (c) shall apply to articles removed after December 31, 2015.
