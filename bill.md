...
- **(a)** *Definitions* In this Act:
  - **(1)** *Assessment* The term assessment means valuation for a property tax that is levied by a taxing authority.
  ...
  - **(4)** *Natural gas pipeline property* The term natural gas pipeline property means all property (whether real, personal, and intangible) used by a natural gas pipeline providing transportation or storage of natural gas subject to the jurisdiction of the Federal Regulatory Commission.
