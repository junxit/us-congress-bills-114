...
This Act may be cited as the “Corporate Inverters Earnings Stripping Reform Act of 2016”.
...
- **(a)** *In general* Section 7874 of the Internal Revenue Code of 1986 is amended by redesignating subsection (g) as subsection (h) and by inserting after subsection (f) the following new subsection:
  ...
  >       - **(i)** *No carryover* No carry­for­ward to any other taxable year shall be allowed under section 163(j)(1)(B) for interest paid or accrued during any additional limitation year with respect to which a deduction was disallowed to the corporation under section 163(j).
  ...
  >     - **(B)** *Failure to comply* If an applicable entity fails to file an application under subparagraph (A), or the approval agreement does not contain the necessary provisions described in subparagraph (C), for any taxable year, then for such taxable year—
