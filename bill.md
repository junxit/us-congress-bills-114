...
- **(a)** *In general* Section 13(3) of the Federal Reserve Act (12 U.S.C. 343(3)) is amended—
  ...
  - **(5)** by adding at the end the following new subparagraphs:
    ...
    >     - **(I)** the average of the discount rate of all Federal Reserve banks over the most recent 90-day period; and
    >     - **(II)** the average of the difference between a corporate bond yield index (as defined by rule of the Board) and a bond yield index of debt issued by the United States (as defined by rule of the Board) over the most recent 90-day period.
...
- **(d)** *Technical and conforming amendments*
  - **(1)** *In general* Section 714 of title 31, United States Code, is amended—
    ...
    - **(B)** in subsection (e), by striking “the third undesignated paragraph of section 13” and inserting “section 13(3)”;
