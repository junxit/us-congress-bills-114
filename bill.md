...
This Act may be cited as the “Small Business Broadband and Emerging Information Technology Enhancement Act of 2015”.
...
- **(2)** According to a report by the Broadband Opportunity Council, dated August 20, 2015, the Council recommends that the United States—
  - **(A)** modernize Federal programs to expand program support for broadband technology investments;
  - **(B)** empower communities with tools and resources to attract investment in and promote meaningful use of broadband technology;
  - **(C)** promote increased deployment of and competition relating to broadband technology through expanded access to Federal assets; and
  - **(D)** improve data collection, analysis, and research on broadband technology.
...
- **(2)** by inserting after section 46 the following:
  ...
  >   - **(1)** the term Associate Administrator means the Associate Administrator for the Office of Investment and Innovation; and
