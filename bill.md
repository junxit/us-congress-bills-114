...
- **(c)** *Regulations* Subsection (c) of such section is amended to read as follows:
  > - **(c)** *Regulations*
...
- **(e)** *Annual report* Subsection (e) of such section is amended—
  ...
  - **(2)** by redesignating clauses (i) through (v) as subparagraphs (A) through (E), respectively, and adjusting the margin of such subparagraphs, as so redesignated, two ems to the left; and
  - **(3)** in paragraph (2) (as redesignated)—
    ...
    - **(B)** in subparagraph (D) (as redesignated), by adding at the end before the period the following: “or chief of mission”;
...
- **(g)** *Repeal of termination* Such section is further amended by striking subsection (i).
