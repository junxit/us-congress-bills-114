...
- **(a)** *In general*
  - **(1)** *Individuals* Subparagraph (E) of section 170(b)(1) of the Internal Revenue Code of 1986, as amended by the Tax Increase Prevention Act of 2014, is amended by striking clause (vi).
  - **(2)** *Corporations* Subparagraph (B) of section 170(b)(2) of such Code, as amended by such Act, is amended by striking clause (iii).
- **(b)** *Contributions of capital gain real property made for conservation purposes by Native Corporations*
  - **(1)** *In general* Section 170(b)(2) of such Code is amended by redesignating subparagraph (C) as subparagraph (D), and by inserting after subparagraph (B) the following new subparagraph:
