...
- **(c)** *Contents*
  ...
  - **(2)** *Data*
    - **(A)** *Industry-wide data* The report shall include data on all proprietary institutions of higher education that consists of information regarding—
      ...
      - **(v)** the average cohort default rate (as defined in section 435(m) of the Higher Education Act of 1965 (20 U.S.C. 1085(m)) for proprietary institutions of higher education, and an annual list of cohort default rates (as so defined) for all proprietary institutions of higher education;
...
- **(c)** *Publication* Not later than July 1 of each fiscal year, the Committee shall publish the list under subsection (a) prominently and in a manner that is easily accessible to parents, students, and other stakeholders, in accordance with any best practices developed under section 3(b)(5).
